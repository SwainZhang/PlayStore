...
public class PagerSlidingTabStripExtends extends HorizontalScrollView {
	...
	public void notifyDataSetChanged() {
		...
		getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
			...
			public void onGlobalLayout() {
				...
				//当我们设置setViewPagerChaged()的时候就回传delegatePageListener
				if(delegatePageListener!=null){//默认选中
	...
	protected void onDraw(Canvas canvas) {
		...
		/*
		x = (lineRight-lineLeft)/2+lineLeft  //三角形的上点
		y = height - indicatorHeight  //三角形的高度
		 */
		/*
